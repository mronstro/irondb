...
SignalDataPrintFunctions[] = {
  ...
  ,{ GSN_COPY_ACTIVEREQ, printCOPY_ACTIVEREQ }
  ,{ GSN_COPY_ACTIVECONF, printCOPY_ACTIVECONF }
  ,{ GSN_COPY_ACTIVEREF, printCOPY_ACTIVEREF }
  ,{ GSN_UPDATE_FRAG_DIST_KEY_ORD, printUPDATE_FRAG_DIST_KEY_ORD }
  ,{ GSN_COPY_FRAG_DONE_REP, printCOPY_FRAG_DONE_REP }
  ,{ GSN_COPY_FRAGREQ, printCOPY_FRAGREQ }
  ,{ GSN_COPY_FRAGCONF, printCOPY_FRAGCONF }
  ,{ GSN_COPY_FRAGREF, printCOPY_FRAGREF }
  ,{ GSN_PREPARE_COPY_FRAG_REQ, printPREPARE_COPY_FRAG_REQ }
  ,{ GSN_PREPARE_COPY_FRAG_CONF, printPREPARE_COPY_FRAG_CONF }
  ,{ GSN_PREPARE_COPY_FRAG_REF, printPREPARE_COPY_FRAG_REF }
  ,{ GSN_HALT_COPY_FRAG_REQ, printHALT_COPY_FRAG_REQ }
  ,{ GSN_HALT_COPY_FRAG_CONF, printHALT_COPY_FRAG_CONF }
  ,{ GSN_HALT_COPY_FRAG_REF, printHALT_COPY_FRAG_REF }
  ,{ GSN_RESUME_COPY_FRAG_REQ, printRESUME_COPY_FRAG_REQ }
  ,{ GSN_RESUME_COPY_FRAG_CONF, printRESUME_COPY_FRAG_CONF }
  ,{ GSN_RESUME_COPY_FRAG_REF, printRESUME_COPY_FRAG_REF }
