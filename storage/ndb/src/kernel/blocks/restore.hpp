...
class Restore : public SimulatedBlock {
 ...
 private:
  ...
  void handle_return_execute_operation(Signal *, FilePtr, const Uint32 *data,
                                       Uint32 len, Uint32 outstanding);
  void execute_operation(Signal *, FilePtr, Uint32 keyLen, Uint32 attrLen,
                         Uint32 op_type, Uint32 gci_id, Uint32 header_type,
                         Local_key *lkey);
